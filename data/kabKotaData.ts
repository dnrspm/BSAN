/** Daftar Kabupaten/Kota per Provinsi (diurutkan berdasarkan abjad) */

const RAW_KAB_KOTA_BY_PROVINSI: Record<string, string[]> = {
  "Aceh": [
  ...
  "Sumatera Utara": [
    "Asahan", "Batu Bara", "Binjai", "Dairi", "Deli Serdang",
    ...
    "Padang Sidempuan", "Pakpak Bharat", "Pematangsiantar", "Samosir", "Serdang Bedagai",
    "Sibolga", "Simalungun", "Tanjungbalai", "Tapanuli Selatan", "Tapanuli Tengah",
    "Tapanuli Utara", "Tebing Tinggi", "Toba",
  ],
  "Sumatera Barat": [
  ...
  "Kepulauan Riau": [
    ...
    "Natuna", "Tanjungpinang",
  ],
  "Jambi": [
    "Batanghari", "Bungo", "Jambi", "Kerinci", "Merangin",
    "Muaro Jambi", "Sarolangun", "Sungai Penuh", "Tanjung Jabung Barat", "Tanjung Jabung Timur",
    "Tebo",
  ],
  "Sumatera Selatan": [
    "Banyuasin", "Empat Lawang", "Lahat", "Lubuklinggau", "Muara Enim",
    "Musi Banyuasin", "Musi Rawas", "Musi Rawas Utara", "Ogan Ilir", "Ogan Komering Ilir",
    "Ogan Komering Ulu", "Ogan Komering Ulu Selatan", "Ogan Komering Ulu Timur", "Pagar Alam",
    "Palembang", "Penukal Abab Lematang Ilir", "Prabumulih",
  ],
  ...
  "Banten": [
    "Cilegon", "Lebak", "Pandeglang", "Serang", "Tangerang",
    "Tangerang Selatan",
  ],
  "Jawa Tengah": [
  ...
  "Nusa Tenggara Barat": [
    "Bima", "Dompu", "Kota Bima", "Lombok Barat", "Lombok Tengah",
    "Lombok Timur", "Lombok Utara", "Mataram", "Sumbawa", "Sumbawa Barat",
  ],
  "Nusa Tenggara Timur": [
    "Alor", "Belu", "Ende", "Flores Timur", "Kupang",
    "Kota Kupang", "Lembata", "Malaka", "Manggarai", "Manggarai Barat",
  ...
  "Kalimantan Tengah": [
    ...
    "Palangka Raya", "Pulang Pisau", "Seruyan", "Sukamara",
  ],
  "Kalimantan Selatan": [
  ...
  "Sulawesi Utara": [
    "Bitung", "Bolaang Mongondow", "Bolaang Mongondow Selatan", "Bolaang Mongondow Timur", "Bolaang Mongondow Utara",
    "Kepulauan Sangihe", "Kepulauan Siau Tagulandang Biaro", "Kepulauan Talaud", "Kotamobagu", "Manado",
    "Minahasa", "Minahasa Selatan", "Minahasa Tenggara", "Minahasa Utara", "Tomohon",
  ],
  "Gorontalo": [
    "Boalemo", "Bone Bolango", "Gorontalo", "Gorontalo Utara", "Kota Gorontalo",
    "Pohuwato",
  ],
  "Sulawesi Tengah": [
  ...
  "Papua Barat": [
    "Fakfak", "Kaimana", "Manokwari", "Manokwari Selatan", "Pegunungan Arfak",
    "Teluk Bintuni", "Teluk Wondama",
  ],
  "Papua": [
    "Biak Numfor", "Jayapura (Kabupaten)", "Jayapura (Kota)", "Keerom", "Kepulauan Yapen",
    "Mamberamo Raya", "Sarmi", "Supiori",
  ],
}

export const KAB_KOTA_BY_PROVINSI: Record<string, string[]> = Object.fromEntries(
  Object.entries(RAW_KAB_KOTA_BY_PROVINSI).map(([provinsi, list]) => [
    provinsi,
